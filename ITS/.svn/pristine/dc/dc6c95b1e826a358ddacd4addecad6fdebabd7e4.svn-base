...
import com.itis.R;
import com.itis.adapter.ImageFolderAdapter;
import com.itis.adapter.ImageListAdapter;
import com.itis.item.LocalMedia;
import com.itis.item.LocalMediaFolder;
import com.itis.utils.FileUtils;
import com.itis.utils.GridSpacingItemDecoration;
import com.itis.utils.LocalMediaLoader;
import com.itis.utils.ScreenUtils;
import com.itis.view.FolderWindow;
...
public class ImageSelectorActivity extends BaseActivity {
    ...
    public final static String EXTRA_DEFAULT_SELECTED_LIST = "SELECTED_LIST";
...
//        enableCrop = getIntent().getBooleanExtra(EXTRA_ENABLE_CROP, false);
        ...
        if (getIntent().hasExtra(EXTRA_DEFAULT_SELECTED_LIST)){
            selectImages = getIntent().getStringArrayListExtra(EXTRA_DEFAULT_SELECTED_LIST);
        }
        initView();
        registerListener();

...
import com.itis.R;
import com.itis.activitys.ImageSelectorActivity;
...
//        this.showCamera = showCamera;
    ...
    public void selectImage(ViewHolder holder, boolean isChecked) {
        ...
        if (isChecked) {
            holder.picture.setColorFilter(context.getResources().getColor(R.color.color_8000), PorterDuff.Mode.SRC_ATOP);
        } else {
            holder.picture.setColorFilter(context.getResources().getColor(R.color.color_2000), PorterDuff.Mode.SRC_ATOP);
        }
    }

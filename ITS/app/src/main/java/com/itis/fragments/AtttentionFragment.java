 ...
 */
public class AtttentionFragment extends Fragment implements PullToRefreshLayout.OnRefreshListener {
    @Bind(R.id.head_view)
    ...
    private void initData( int p) {
        ...
        Connector.world_cricle_list(String.valueOf(p), "1", new Callback.CommonCallback<String>() {
            @Override

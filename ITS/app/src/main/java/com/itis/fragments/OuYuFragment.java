 ...
 */
public class OuYuFragment extends Fragment implements PullToRefreshLayout.OnRefreshListener{
    @Bind(R.id.head_view)
    ...
    private void initData( int p) {
        ...
        Connector.world_cricle_list(String.valueOf(p), "2", new Callback.CommonCallback<String>() {
            @Override
            public void onSuccess(String result) {
                try {
                    JSONObject jsonObject = new JSONObject(result);
                    Log.e("sssssss",result);
                    Gson gson=new Gson();

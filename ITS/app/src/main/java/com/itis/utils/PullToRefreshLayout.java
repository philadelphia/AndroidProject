...
//			refreshStateTextView.setText(R.string.pull_to_refresh);
		...
		/*	refreshingView.setVisibility(View.VISIBLE);
			refreshingView.setBackgroundResource(R.anim.refres);*/
			// 上拉布局初始状态
...
//		pullView = refreshView.findViewById(R.id.pull_icon);
		...
		refreshingView.setBackgroundResource(R.anim.refres);
		AnimationDrawable anim = (AnimationDrawable) refreshingView.getBackground(); //获取ImageView背景,此时已被编译成AnimationDrawable
		anim.start();  //开始动画

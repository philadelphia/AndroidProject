package com.tutorialsbuzz.recyclerviewitemleftswipe.SwipeUtil;
...
public abstract class SwipeUtil extends ItemTouchHelper.SimpleCallback {
    ...
    public void onChildDraw(Canvas c, RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder,
        ...
        Log.i(TAG, "itemView.getLeft: " + itemView.getLeft());
        Log.i(TAG, "itemView.getRight(): " + itemView.getRight());
        Log.i(TAG, "itemView.getTranslationX: " + itemView.getTranslationX());
        if (dX < 0) {
            Log.i(TAG, "onChildDraw: 向左滑动");
        }
        else {
